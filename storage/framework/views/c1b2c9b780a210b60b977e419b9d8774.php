        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <p>
                        <a href="<?php echo e(route('posts.create')); ?>" class="btn btn-primary my-2">Create Post</a>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            ...
                                            <a class="btn btn-sm btn-outline-secondary"
                                                href="<?php echo e(route('posts.edit', ['post' => $post->id])); ?>">Edit</a>
                                        </div>
...
<?php /**PATH C:\Users\GOLD\Desktop\laravel-CRUD\resources\views/posts/index.blade.php ENDPATH**/ ?>